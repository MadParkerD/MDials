...
void loop() {
  // read the input on analog pin 0, setting one pin to high and one to ground
  digitalWrite(7,HIGH);
  digitalWrite(6,LOW);
  ...
  //Send relevant control changes over midiusb. Devide values by eight to get range of 0-127
